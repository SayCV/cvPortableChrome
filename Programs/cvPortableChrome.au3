...
If Not FileExists($inifile) Then
	...
	IniWrite($inifile, "Settings", "UserDataDir", "..\UserData")
	...
	IniWrite($inifile, "Settings", "ChromeSource", "sina.com.cn")
...
If StringInStr($Params, "--user-data-dir=") Then
	$PortableParam = ''
Else
...
Func Settings()
	...
	$hSettings = GUICreate(lang("GUI", "Title", 'cvPortableChrome - 打造自己的 Google Chrome 便携版'), 500, 530)
	GUISetOnEvent($GUI_EVENT_CLOSE, "ExitApp")
	Local $LangCopyright = lang("GUI", "Copyright", 'cvPortableChrome %s by ')
	$LangCopyright = StringFormat($LangCopyright, $AppVersion)
	GUICtrlCreateLabel($LangCopyright, 5, 10, 490, -1, $SS_CENTER)
	GUICtrlSetCursor(-1, 0)
	GUICtrlSetColor(-1, 0x0000FF)
	GUICtrlSetTip(-1, lang("GUI", "CopyrightTips", '点击打开 cvPortableChrome 主页'))
